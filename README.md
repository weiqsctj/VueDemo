...
![src_默认插槽](src/assets/默认插槽.gif)

### 6.2.具名插槽

![src_具名插槽](src/assets/具名插槽.gif)
...
7. 注意：通过`this.$refs.xxx.$on('weiqsctj',回调)`绑定自定义事件时，回调<span style="color:red">要么配置在 methods 中</span>，<span style="color:red">要么用箭头函数</span>，否则 this 指向会出问题！
